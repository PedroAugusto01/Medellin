...
function calculateFarmToMuni() {
    ...
    for(var item in result) {
        ...
        let itemValue = parseInt(((parseInt($(itemHtml).val() , 10) * valuePorcent) / (result[item]['porcentagemBancadaZero'] / 10)), 10);
        if (!isNaN(itemValue)) {
...
function calculateMuniToFarm() {
    ...
    for(var item in result) {
        let itemHtml = "#"+result[item]['qtyCalcBancada']
        let priceHtml = "#"+result[item]['priceCalcBancada']
        let itemValue = parseInt(((parseInt($(priceHtml).val() , 10) * (result[item]['valorBancada'] / 10)) / result[item]['porcentagemBancadaZero']), 10) 
